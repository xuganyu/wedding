...
//$db = new Dbmysql ( 'localhost', 'root', '123456', 'zkcao_kk', 'utf8' );
*/
...
class Dbmysql {
     ...
     */
    public function __construct($host = "localhost", $username = "root", $password = "123456", $database = 'cllcfz_kk', $charset = "utf8") {
        $this->host = $host;
    ...
    private function _retrieve() {
        ...
        $value .= '-- Created by Dbmysql class, Power By yanue. ' . $this->ds;
        $value .= '-- http://www.ziskia.com ' . $this->ds;
        $value .= '--' . $this->ds;
