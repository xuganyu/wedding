...
<body>
  <div class="panel admin-panel">
      <div class="panel-head"><strong class="icon-reorder"> 添加成功故事</strong></div>
    	<div class="tab-box">
			<div class="tab"style="padding-left:200px">
				<div class="tab-panel" id="tab-b">
					<div class="common-info">
						<form class="form-x"  enctype="multipart/form-data" action="<?php echo site_url("admin/stories/do_add");?>" method="post">
							<div class="form-group">
								<div class="label">
									<label>标题：</label>
								</div>
								<div class="field" style="width:500px">
									<input type="text" class="input" name="title" placeholder="" data-validate="required:必填" />
								</div>
							</div>
							<div class="form-group">
								<div class="label">
								...
								<div class="field" style="width:500px">
									<textarea class="input" name="content" placeholder="" style="resize: none;height: 300px !important;" data-validate="required:必填" ></textarea>
								</div>
							</div>
							<div class="form-group">
								<div class="label">
								...
								<div class="field field-tsa" style="width:500px">
									...
									<input type="file" class="input" name="image" accept="image/*" data-validate="required:请选择文件,regexp#.+.(jpg|jpeg|png|gif)$:只能上传jpg|gif|png格式文件" />
									</a>
								</div>
							</div>
