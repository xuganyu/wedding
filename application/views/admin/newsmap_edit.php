			...
			<div class="tab"style="padding-left:200px">
				<div class="tab-panel" id="tab-b">
					<div class="common-info">
						<form class="form-x"  enctype="multipart/form-data" action="<?php echo site_url("admin/newsmap/do_edit");?>" method="post">
							<input type="hidden" name="formid" value="<?php echo $edit['banner_id']; ?>" />
							<div class="form-group">
								<div class="label">
									<label>图片标题：</label>
								</div>
								<div class="field" style="width:300px">
									<input type="text" class="input" value="<?php echo $edit['banner_title'];?>" name="title"placeholder="链接地址不用再写Http前缀了..." />
								</div>
							</div>
							<div class="form-group">
								<div class="label">
								...
								<div class="field" style="width:300px">
									<input type="text" class="input" value="<?php echo $edit['banner_url'];?>" name="url"placeholder="链接地址不用再写Http前缀了..." />
								</div>
							</div>
							<div class="form-group">
								<div class="label">
								...
								<div class="fileupload-new thumbnail" style="width:400px; height:200px;">
                                      <img src="<?php echo base_url("uploads/".$edit['banner_thumb']);?>" />
                                </div>
                                 <style>.kkimg img{ margin-top:-13px;}</style>
                                                        <div class="fileupload-preview fileupload-exists thumbnail kkimg" style="width:400px; height:200px;"></div>
