            ...
            <form action="<?php echo site_url("admin/login");?>" method="post">
                <div class="panel loginbox">
                    ...
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        ...
                        <!-- <div class="form-group">
                            <div class="field">
                                <input type="text" class="input input-big" name="imgcode" placeholder="填写右侧的验证码" data-validate="required:请填写右侧的验证码" />
                                <a href="javascript:reloadCode();"><img  name="checkCodeImg" id="checkCodeImg" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;"></a>  
                            </div>
                        </div> -->
                    </div>
...
function reloadCode() {
	...
	dom.src = "<?php echo site_url('zkadmin/login/captcha');?>?str=" + Math.random();
}
$(function(){
	reloadCode();
});
