...
<div class="button-toolbar">
	<div class="button-group" style="margin: 0px 10px">
		搜索意中人：
	</div>
	<div class="button-group" style="margin: 0px 10px">
		<button type="button" class="button  dropdown-toggle">
		性别 <span class="downward"></span>
		</button>
		<ul class="drop-menu">
			<li><a href="#">男士</a> </li>
			<li><a href="#">女士</a> </li>
	...
	<div class="button-group" style="margin: 5px 10px">
		<button type="button" class="button dropdown-toggle">
		年龄 <span class="downward"></span>
		</button>
		<ul class="drop-menu">
			<li><a href="#">18-28</a> </li>
			<li><a href="#">28-38</a> </li>
			<li><a href="#">28-38</a> </li>
			<li><a href="#">38-48</a> </li>
			<li><a href="#">48-58</a> </li>
			<li><a href="#">58-68</a> </li>
			
		</ul>
	</div>
	<div class="button-group" style="margin: 0px 10px">
		<button type="button" class="button dropdown-toggle">
		学历<span class="downward"></span>
		</button>
		<ul class="drop-menu">
			<li><a href="#">高中中专及以下</a> </li>
			<li><a href="#">大专</a> </li>
			<li><a href="#">本科</a> </li>
			<li><a href="#">双学士</a> </li>
			<li><a href="#">硕士</a> </li>
	...
	<div class="button-group" style="margin: 0px 10px">
		<button type="button" class="button dropdown-toggle">
		月收入<span class="downward"></span>
		</button>
		<ul class="drop-menu">
			<li><a href="#">2000元以下</a> </li>
			<li><a href="#">2000-5000元</a> </li>
			<li><a href="#">5000-10000元</a> </li>
			<li><a href="#">10000-20000元</a> </li>
			<li><a href="#">20000-50000元</a> </li>
			<li><a href="#">250000元以上</a> </li>
			
		</ul>
	</div>
	<button  data-toggle="click" data-target="#mydialog" class="button border-dot dialogs" data-mask="1" data-width="50%">
	更多条件查找</button>
...
<!-- 
 ...
 <table width="80%" cellpadding="10" class="table table-striped">
 	<tr >
	 	<th>
	 		<p class="text-align">
	 		搜索意中人： 
 		...
 		<td >
 			<select id="edu55" name="edu55" onchange="change()" class="input" style="width:150px">
 		...
 		<td>
 			<select id="salary" name="salary" class="input" style="width:150px" >
 		...
 		<td>
 			<select id="education" name="education" class="input" style="width:150px">
 		...
 		<td>
 			<select id="yueshouru" name="salary" class="input" style="width:150px">
			  <option value="0">月收入</option>
			    ...
			    <option value="5">250000元以上</option>
			</select>
 		</td>
 		<td>
 			<button   href="#" data-toggle="modal" data-target="#myModal" class=" button border-red">更多条件查找</button>
 		</td>
...
<div id="mydialog">
	<div class="dialog">
 	...
 	<tr >
 		...
 		<td>
 			<select id="shengfen" name="province" class="input" style="width:150px" onchange="changePro(this.options[this.options.selectedIndex].value);">
			   	  <option value="0">省份</option>
			</select>
 		</td>
 		<td>
 			<select id="chengshi" name="city" class="input" style="width:150px">
			   	  <option value="0">城市</option>
			</select>
 		</td>
 		<td>
 			<select id="xiaqu" name="country" class="input" style="width:150px">
...
<div class="zy">
  ...
  <div class="zy_right">
    <div class="hszs_nei">
      ...
      <div class="img_pagr">
	      <a href="#" title="T3套系 天然氧吧渡假式海湾海景基地——本季最热套餐6999元">上一页</a>
	      <a href="#">123456</a>
	      <a href="#" title="T5套系 白宫奢华殿堂+南亚湾海景——双外景套餐6999元">下一页</a>
      </div>
      <div class="clear"></div>
    </div>
  </div>
...
<script type="text/javascript">
		...
		$(function(){
			console.log(china_city);
			var province_str = '', country_str = '';
			$.each(china_city, function(ck, cv){
				province_str += '<option data-name="' + cv.n + '">' + cv.n + '</option>';
			});

			console.log(province_str);
			$('#shengfen').find("option[value='0']").append(province_str);

		});

		function changePro(vv){
			console.log(vv)
			var city_str = '';
			var oldBtn = document.getElementById('chengshi');
			...
			$.each(china_city, function(ck, cv){
				...
				if( vv== cv.n){
					$.each(cv, function(k, v){
						if(k != 'n'){
							city_str += '<option value="' + v.n + '">' + v.n + '</option>';
							oldBtn.options.add(new Option(v.n,v.n));
