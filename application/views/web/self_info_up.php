...
<div class="middle-part" style="height: auto;">
    <div class="reg-box-left">
        <div class="reg-form">
            <form action="<?php echo site_url('web/login/self_info_do_up')?>" method="post" id="self_info_up_form" onsubmit="return check_form(this);">
            <!-- 生日 -->
            <div class="col-form">
                <label>出生日期：</label>
                <div class="za-item-selector" id="birthday_seletor">
					...
					<dl class="year-selector">
						...
						<input id="birth_year_input" value="<?php echo $birth[0] ?>" type="hidden" name="birth_year">
						<dd style="display: none;"></dd>
					</dl>
					<dl class="month-selector">
						<dt><em class="cData"></em><em class="iName">月</em></dt>
						<input id="birth_month_input" value="<?php echo $birth[1] ?>" type="hidden" name="birth_month">
					...
					<dl class="day-selector" style="position: relative;">
						...
						<input id="birth_date_input" value="<?php echo $birth[2] ?>" type="hidden" name="birth_date">
						<dd style="display: none;"></dd>
					</dl>
				</div>
            ...
            <div class="col-form">
                ...
                <div class="za-item-selector" id="area_seletor">
					<dl class="province-selector">
						...
						<input value="<?php echo $info['province']?>" type="hidden" name="province" id="province_input" />
						<dd style="display: none;">
						</dd>
					</dl>
					...
					<dl class="city-selector">
						...
						<input value="<?php echo $info['city']?>" type="hidden" name="city" id="city_input">
						<dd style="display: none;">
							请选择所在的省份
						</dd>
					</dl>
					...
					<dl class="county-selector">
						...
						<input value="<?php echo $info['country']?>" type="hidden" name="country" id="country_input">
						<dd style="display: none;">
							请选择所在的城市
						</dd>
					</dl>
            ...
            <div class="col-form">
                ...
                <div class="za-radio marry-radio" id="MaritalStatus">
					<input type="radio" name="marriage" value="1" id="mar_0"><label for="mar_0">未婚</label>
            ...
            <div class="col-form">
                ...
                <div class="za-item-selector" id="HeightSelector">
					<input name="height" value="<?php echo $info['height']?>" type="hidden" id="height_input">
            ...
            <div class="col-form">
                ...
                <div class="za-item-selector" id="EducationSelector">
					<input name="education" value="<?php echo $info['education']?>" type="hidden" id="education_input">
            ...
            <div class="col-form">
                ...
                <div class="za-item-selector" id="SalarySelector">
					<input name="salary" value="<?php echo $info['salary']?>" type="hidden" id="salary_input">
            ...
            <div class="col-form">
                ...
                <div class="za-item-selector">
                    <input name="nickname" type="text" id="nickname_input" value="<?php echo $info['nickname'] ?>">
                </div>
            ...
            <div class="col-form" style="width: 900px;">
                ...
                <div class="za-item-selector" style="width: 600px;height: auto;">
                    <textarea name="intro" id="intro_input" style="width: 500px;padding-top: 5px;"><?php echo $info['intro'] ?></textarea>
                </div>
            ...
            <div style="padding-left: 250px;">
                ...
                <br>
                <br>
                <a id="self_info_up_btn" class="button-self" style="cursor: pointer;">提交</a>
            </div>
            <br/>
            <br/>
        </div>
...
//填充
var birth = JSON.parse('<?php echo json_encode(explode('-', $info['birthday']))?>');
$('.year-selector').find('dt').find("em[class='cData']").html(birth[0]);
$('.month-selector').find('dt').find("em[class='cData']").html(birth[1]);
$('.day-selector').find('dt').find("em[class='cData']").html(birth[2]);
$('.province-selector').find('dt').find("em[class='iName']").html('');
$('.province-selector').find('dt').find("em[class='cData']").html('<?php echo $info['province']?>');
$('.city-selector').find('dt').find("em[class='iName']").html('');
$('.city-selector').find('dt').find("em[class='cData']").html('<?php echo $info['city']?>');
var country = '<?php echo $info['country']?>';
if(country != '' && country != null && country != 'NULL'){
    $('.county-selector').find('dt').find("em[class='iName']").html('');
    $('.county-selector').find('dt').find("em[class='cData']").html('<?php echo $info['country']?>');
}else{
	$('.county-selector').hide();
}
$('.marry-radio').find("input[value='<?php echo $info['marriage']?>']").attr('checked', 'checked');
$('.height-selector').find('dt').find("em[class='iName']").html('');
$('.height-selector').find('dt').find("em[class='cData']").html('<?php echo $info['height']?>'+'厘米');
var education = '<?php switch ($info['education']){ case 1:echo '高中中专及以下'; break; case 2:echo '大专'; break; case 3:echo '本科'; break; case 4:echo '双学士'; break; case 5:echo '硕士'; break; case 6:echo '博士'; break; default:echo '博士后'; }?>';
$('.education-selector').find('dt').find("em[class='iName']").html('');
$('.education-selector').find('dt').find("em[class='cData']").html(education);
var salary = '<?php switch ($info['salary']){ case 1: echo '2000元以下'; break; case 2: echo '2000-5000元'; break; case 3: echo '5000-10000元'; break; case 4: echo '10000-20000元'; break; case 5: echo '20000-50000元'; break; default: echo '50000元以上'; } ?>';
$('.salary-selector').find('dt').find("em[class='iName']").html('');
$('.salary-selector').find('dt').find("em[class='cData']").html(salary);

$('#self_info_up_btn').click(function(){
	$('#self_info_up_form').submit();
});
</script>
</body>
</html>