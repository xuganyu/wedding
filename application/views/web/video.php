...
<!-- 子页修改 图片展示 内容 -->
<div class="title">
  <div class="title_01"><a href="#">HOME</a>><a href="#">作品展示</a>><a href="#">内景婚纱展示</a></div>
</div>
...
<div class="zy">
  <div class="zy_imgli">
    <div class="img_bt">
      <div class="img_btli">
        <img src="<?php echo base_url('zeros/web/images/rwt.jpg'); ?>" />
    ...
    <div class="img_nei">
      <UL>
        <LI><img src="<?php echo base_url('zeros/web/images/05.jpg'); ?>" /></LI>
